...
public:
    static bool autodetectOnLoad();
    static bool liveUpdatingOfIris();
    static void savePrefs(bool autodetectOnLoad, bool liveUpdatingOfIris);
    static void readPrefs();

private:
    static bool _autodetectOnLoad;
    static bool _liveUpdatingOfIris;
